...
public class MyProductsFragment extends Fragment {
    ...
    public void setView() {
        ...
        FirebaseRecyclerAdapter firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Product, MyProductViewHolder>
                (Product.class, R.layout.list_item_my_product, MyProductViewHolder.class, query) {

            @Override
            protected void populateViewHolder(MyProductViewHolder viewHolder, Product model, int position) {
